...
def get_sp400_symbols():
    page_html_sp400 = wiki_html('List_of_S%26P_400_companies', 'SP400.html')
    wiki_soup_sp400 = BeautifulSoup(page_html_sp400, "html.parser")
    symbol_table = wiki_soup_sp400.find(attrs={'class': 'wikitable sortable'})
